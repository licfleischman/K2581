...
class Musico {
	...
	constructor(unGrupo, unaHabilidad, unosAlbumes) {
		grupo = unGrupo habilidad = unaHabilidad albumes = unosAlbumes
	}
...
class MusicoVocalista inherits Musico {
	...
	constructor(unGrupo, unaHabilidad, unosAlbumes, unaPalabra) = super ( unGrupo
	, unaHabilidad , unosAlbumes ) {
		palabra = unaPalabra
	}
...
class MusicoDeGrupo inherits Musico {
	...
	constructor(unGrupo, unaHabilidad, unosAlbumes, unPlus) = super ( unGrupo ,
	unaHabilidad , unosAlbumes ) {
		plus = unPlus
	}
	method interpretaBien(cancion) {
